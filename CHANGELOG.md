...
- Add JSON validation rule
  - Implemented by [@ns-vasilev](https://github.com/ns-vasilev) in Pull Request [#116](https://github.com/space-code/validator/pull/116).
...
- Make IValidatorError conform to LocalizedError
  - Implemented by [@ns-vasilev](https://github.com/ns-vasilev) in Pull Request [#113](https://github.com/space-code/validator/pull/113).

## [1.4.0](https://github.com/space-code/validator/releases/tag/1.4.0)

Released on 2025-12-20. All issues associated with this milestone can be found using this [filter](https://github.com/space-code/validator/milestones?state=closed&q=1.4.0).
...
- Add iban validation rule
  - Implemented by [@ns-vasilev](https://github.com/ns-vasilev) in Pull Request [#88](https://github.com/space-code/validator/pull/88).
- Add comparison validation rule
  - Implemented by [@ns-vasilev](https://github.com/ns-vasilev) in Pull Request [#86](https://github.com/space-code/validator/pull/86).
...
[unreleased]: https://github.com/space-code/validator/compare/1.5.0..HEAD
